...
@section('content')
                    ...
                    <li class="second admin-pic">
                        <ul>
                            <li class="dropdown profile_details_drop">
                                <a href="#" clHoass="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                ...
                                <ul class="dropdown-menu drp-mnu">
                                    <li><a href="/listorder"><i class="fa fa-cog"></i> Danh sách đơn hàng</a></li>
                ...
                <ul>
                    ...
                    <li>
                        <form action="#" method="get" class="last">
                            ...
                            <button class="button-cart" class="top_shoe_cart" type="submit" name="submit" value="">
                                <i
                        ...
                        <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                            <nav class="menu menu--miranda">
                                <ul class="nav navbar-nav menu__list">
                                    <li class="menu__item menu__item--current"><a href="{{url('/')}}"
                                                                                  class="menu__link">TRANG
                                            CHỦ</a>
                                    </li>
                                    <li class="menu__item"><a href="{{url('about')}}" class=" menu__link">GIỚI
                                            THIỆU</a></li>
                                    ...
                                    <li class="menu__item"><a href="{{url('menu')}}" class=" menu__link">THỰC
                                            ĐƠN</a></li>
            ...
            <div class="book-form">
                ...
                <form action="/booking" method="post">
                    ...
                    <div class="col-md-3 form-date-w3-agileits">
                        ...
                        <input id="datepicker1" name="date" type="text" value="mm/dd/yyyy"
                               onfocus="this.value = '';"
    ...
    <div class="ab-w3l-about">
        <div class="container">
            ...
            <p class="para-w3l">Food Paradise là một trung tâm hội nghị hàng đầu với lối kiến trúc sang trọng, tinh
                tế,
                những tiêu chuẩn đẳng cấp cùng chất lượng dịch vụ chuyên nghiệp bậc nhất tại Thành Phố Hồ Chí Minh.
                Tổng
                diện tích sử dụng trên 6,500 mét vuông mang lại cho Food Paradise không gian mở rộng rãi, phù hợp
                nhiều
                loại hình hội nghị, sự kiện khác nhau. Cho dù bạn tổ chức một cuộc họp hội đồng quản trị cho 30
                người
                hay Đại hội cổ đông cho 3.500 người hoặc một bữa tiệc cho 3.000 khách mời, Trung tâm hội nghị Food
                Paradise luôn sẵn sàng phục vụ và đáp ứng tốt nhất các yêu cầu của bạn để cùng mang đến thành công
                tốt
                đẹp.
        ...
        <div class="col-md-6 ab-w3-agile-info">
            <div class="ab-w3-agile-info-text">
                ...
                <p class="para-w3l">Lorem ipsum dolor sit amet, consectetur adipisc elit. Proin ultricies vestibulum
                    velit.Lorem ipsum dolor sit amet.when an unknown printer took a galley of type and scrambled it
                    to
            ...
            <div class="ab-w3-agile-inner">
                <div class="col-md-6 ab-w3-agile-part">
                    ...
                    <p class="para-w3l">Lorem ipsum dolor sit amet, consectetur adipisc elit. Proin ultricies
                        vestibulum
        ...
        <div class="container">
            ...
            <div class="g1 agile-blog1">
                ...
                <div class="text-w3">
                    ...
                    <p class="para-w3l">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                        tempor
    ...
    <div class="services-w3layouts" id="services">
        ...
        <div class="col-md-6 agitsworkw3ls-grid ">
            ...
            <p class="para-w3l">Gourmet is a full-service catering and event planning company dedicated to providing
                you
                with exquisite cuisine and fantastic customer service. We offer a variety of menus and design
                options,
