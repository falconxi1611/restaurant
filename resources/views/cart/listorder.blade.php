...
@section('main_content')
    ...
    <div class="checkout_margin" style="margin-bottom: 160px">
        <div class="container">
            <div class="row">
                        ...
                        @foreach($arrOrder as $order)
                            <li>
                                <time datetime="{{$order->ORDER_DATE}}">
                                    <span class="day">{{substr($order->ORDER_DATE, 9, 2)}}</span>
                                    <span class="month">Jul</span>
                                    <span class="year">{{substr($order->ORDER_DATE, 1, 4)}}</span>
                                    <span class="time">ALL DAY</span>
                                </time>
                                <img alt="Independence Day"
                                     src="https://farm4.staticflickr.com/3100/2693171833_3545fb852c_q.jpg"/>
                                <div class="info">
                                    <h2 class="title">Order Số {{$order->ORDER_ID}}</h2>
                                    <p class="desc">Tiệc Cưới</p>
                                </div>
                                <div class="social">
                                    <ul>
